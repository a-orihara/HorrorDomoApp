...
4. liked_postsという命
名は、liked_postsという名前から、これが「ユーザーがいいねした投稿」を表していることが直
感的にわかります。
================================================================================================
17
1. "いいね"を確認するメソッドは、UserモデルでもPostモデルでも定義することができます。どちらに書くかは、実装者の設
計意図や使い勝手によるところが大きいです。Userモデルに書くことで「ユーザーが特定の投稿にいいねをしたかどうか」を直
感的に確認できますし、Postモデルに書くことで「特定の投稿が特定のユーザーからいいねをもらっているかどうか」を直感的
に確認できます。
2. 一般的に、LikeモデルはUserとPostの中間テーブルとしての役割を持ちます。このため、UserとPostの間の関連性を表す
