...
Rails.application.configure do
  ...
  # 5.1 5.2 5.3 下記設定あるも、実際には使用していない。
...
================================================================================================
5.1
開発環境でメール内で生成される認証用のURLがlocalhost:3010となるように指定
しかし、実際のアカウント認証のフローは、「アカウントを有効化する」をクリックすると、フロントにアクセスするよう設計
している為、使用していない。
------------------------------------------------------------------------------------------------
...
ホスト側の3010でrailsコンテナが3000で待ち受けるので、3010を指定。
------------------------------------------------------------------------------------------------
...
設定がメール内のリンクのベースURLを指定するために使用されるということです。
------------------------------------------------------------------------------------------------
. **メール内リンクの生成**
