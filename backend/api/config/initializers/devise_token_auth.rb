...
================================================================================================
3
config.headers_namesは、devise_token_authがリクエストとレスポンスのヘッダーで使用するデフォルトのヘッダー名
をカスタマイズするための設定です。
...
------------------------------------------------------------------------------------------------
config.headers_names設定を使用することで、これらのヘッダー名をプロジェクトの要件に応じて変更できます。ただし、
変更する場合は、フロントエンド側でも対応するヘッダー名を変更する必要があります。
